...
public class MapperVehiculo {
	...
	public Vehiculo mapperEntityToDominio(VehiculoEntity vehiculoEntity) {
		Vehiculo objeto;
		objeto = (vehiculoEntity == null) ? null :  new Vehiculo(vehiculoEntity.getId(),
				vehiculoEntity.getPlaca(), vehiculoEntity.getTipoId(),
	...
	public VehiculoEntity mapperDominioToEntity(Vehiculo vehiculo) {
		...
		objeto = (vehiculo == null) ? null : new VehiculoEntity(vehiculo.getId(),
				vehiculo.getPlaca(), vehiculo.getTipoId(),

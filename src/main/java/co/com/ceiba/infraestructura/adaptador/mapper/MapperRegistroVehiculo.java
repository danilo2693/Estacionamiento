...
public class MapperRegistroVehiculo {
	...
	public RegistroVehiculo mapperEntityToDominio(RegistroVehiculoEntity registroVehiculoEntity, MapperVehiculo mapperVehiculo) {
		...
		objeto = (registroVehiculoEntity == null) ? null :  new RegistroVehiculo(registroVehiculoEntity.getId(),
				mapperVehiculo.mapperEntityToDominio(registroVehiculoEntity.getVehiculo()), registroVehiculoEntity.getEntrada(),
	...
	public RegistroVehiculoEntity mapperDominioToEntity(RegistroVehiculo registroVehiculo, MapperVehiculo mapperVehiculo) {
		...
		objeto = (registroVehiculo == null) ? null : new RegistroVehiculoEntity(registroVehiculo.getId(),mapperVehiculo.mapperDominioToEntity(registroVehiculo.getVehiculo()) ,
